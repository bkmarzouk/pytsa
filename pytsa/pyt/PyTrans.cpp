...
// **************************************************************************************
static struct PyModuleDef PyTransModule = {PyModuleDef_HEAD_INIT, "dquad_2sphere", PyTrans_docs, -1, dquad_2sphere_funcs}; //modDef
// do not alter the comment at the end of preceeding line -- it is used by preprocessor

// **************************************************************************************
PyMODINIT_FUNC PyInit_dquad_2sphere(void)    {import_array();  return PyModule_Create(&PyTransModule);} //initFunc
// do not alter the comment at the end of preceeding line -- it is used by preprocessor
