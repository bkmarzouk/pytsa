...
# We also sample the metric parameter, R. Here we sample from the chi2 distribution.
# We chose this dist. since it is positive definite and the metric depends on R^2, so we don't over sample.
