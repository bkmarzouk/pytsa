...
setup = setup_sampler.SamplerMethods(dquad_euclidean, "dquad_euclidean_example")
...
# Setup parameter sampling; here we sample each mass parameter from a log-uniform distribution
setup.set_param(0, 1, method=loguniform(1e-6, 1e-2))
