...
setup(name="PyTransd3brane_deltamax_3pt005_all", version="1.0", ext_modules=[Extension("PyTransd3brane_deltamax_3pt005_all", [filename, filename2 ])], include_dirs=[numpy.get_include(), dirs], extra_compile_args = ["-std=c++11 -frounding-math -fsignaling-nans"])#setup
###################################################################################################