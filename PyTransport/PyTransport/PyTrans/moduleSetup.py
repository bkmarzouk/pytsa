...
setup(name="PyTransdb6beta_dmax_6pt0", version="1.0", ext_modules=[Extension("PyTransdb6beta_dmax_6pt0", [filename, filename2 ])], include_dirs=[numpy.get_include(), dirs], extra_compile_args = ["-std=c++11"])#setup
###################################################################################################