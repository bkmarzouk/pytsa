...
setup(name="PyTrans3Quad", version="1.0", ext_modules=[Extension("PyTrans3Quad", [filename, filename2 ])], include_dirs=[numpy.get_include(), dirs], extra_compile_args = ["-std=c++11"])#setup
###################################################################################################