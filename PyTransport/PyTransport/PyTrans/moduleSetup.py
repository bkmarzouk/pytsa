...
setup(name="PyTransagarwal_6pt0_newMab", version="1.0", ext_modules=[Extension("PyTransagarwal_6pt0_newMab", [filename, filename2 ])], include_dirs=[numpy.get_include(), dirs], extra_compile_args = ["-std=c++11"])#setup
###################################################################################################