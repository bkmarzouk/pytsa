...
void r8_fehl ( void f ( double t, double y[], double yp[], double params[] ), int neqn,
              ...
              double f3[], double f4[], double f5[], double s[], double params[] )
...
//    C++ version by John Burkardt. Minor edit to pass parameters to odes by
//    David Mulryne
//
//  Reference:
//
...
//
//      void f ( double t, double y[], double yp[], double params[] )
//
...
int r8_rkf45 ( void f ( double t, double y[], double yp[], double params[] ), int neqn,
              ...
              double abserr, int flag,  double params[] )
...
//
//    Original FORTRAN77 version by Herman Watts, Lawrence Shampine.
//    C++ version by John Burkardt. Minor edit to pass parameters to odes
//    by David Mulryne.
//
//  Reference:
//
...
//    derivatives Y'(T), of the form:
//
//      void f ( double t, double y[], double yp[], params[] )
//
//    Input, int NEQN, the number of equations to be integrated.
//
...
//                cerr << "  ABSERR <= ABSERR_SAVE\n";
    ...
    for ( ; ; )
    {
        ...
        for ( ; ; )
        {
            ...
            //
            r8_fehl ( f, neqn, y, *t, h, yp, f1, f2, f3, f4, f5, f1, params );
            nfe = nfe + 5;
            //
