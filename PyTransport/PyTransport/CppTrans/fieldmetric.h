...
// Christoffel
  ...
  auto x14 = (1.0/3.0)*x9;
  auto x15 = x14*x4;
  auto x16 = 1.0/std::tan(f[1]);
  auto x17 = (2.0/3.0)*x16;
  auto x18 = 1.0/x1;
  auto x19 = (1.0/3.0)*x18;
  auto x20 = -x19*x3;
  auto x21 = -x19;
  auto x22 = 1.0/x9;
  auto x23 = (1.0/3.0)*x22;
  auto x24 = -x23*x4;
  auto x25 = 1.0/std::tan(f[2]);
  auto x26 = (2.0/3.0)*x25;
  auto x27 = -x23;
  auto x28 = (1.0/6.0)*x1 - 2.0/3.0*x18;
  auto x29 = (1.0/3.0)*x16;
  auto x30 = x29*x3;
  auto x31 = (1.0/3.0)*x25;
  auto x32 = x31*x4;
  auto x33 = -2.0/3.0*x22 + (1.0/6.0)*x9;
