...
// Riemanncd
  ...
  auto x22 = x10*x5;
  auto x23 = -x22;
  auto x24 = std::cos(f[1]);
  auto x25 = std::pow(f[0], 2)*x0;
  auto x26 = (1.0/108.0)*x25;
  auto x27 = x26*x8;
  auto x28 = x24*x27;
  auto x29 = std::sin(2*f[2]);
  auto x30 = (1.0/216.0)*x25;
  auto x31 = x29*x30;
  auto x32 = -x6;
  auto x33 = std::sin(2*f[1]);
  auto x34 = x30*x33;
  auto x35 = -x34;
  auto x36 = std::cos(f[2]);
  auto x37 = x26*x4;
  auto x38 = x36*x37;
  auto x39 = -x38;
  auto x40 = -x37;
  ...
  auto x45 = x44*x5;
  auto x46 = -x45;
  auto x47 = (1.0/54.0)*x25;
  auto x48 = x33*x47;
  auto x49 = x4*x47;
  auto x50 = x36*x49;
  auto x51 = (1.0/72.0)*x25;
  auto x52 = x33*x51;
  auto x53 = -x52;
  auto x54 = x12*x44;
  auto x55 = x47*x8;
  ...
  auto x59 = -x49;
  auto x60 = -x48;
  auto x61 = std::pow(x4, 3)*x47;
  auto x62 = x36*x61;
  auto x63 = (1.0/36.0)*x25;
  auto x64 = x24*x4*x63*x9;
  auto x65 = -x54;
  auto x66 = -x62;
  auto x67 = -x64;
  auto x68 = x49*x9;
  ...
  auto x87 = -x86;
  auto x88 = x29*x47;
  auto x89 = x36*x5*x63*x8;
  auto x90 = -x89;
  auto x91 = x47*std::pow(x8, 3);
  auto x92 = x24*x91;
  auto x93 = -x92;
  auto x94 = x5*x55;
  auto x95 = -x94;
