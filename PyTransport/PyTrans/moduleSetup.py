...
setup(name="PyTrans5quad_euclidean", version="1.0", ext_modules=[Extension("PyTrans5quad_euclidean", [filename, filename2 ])], include_dirs=[numpy.get_include(), dirs], extra_compile_args = ["-std=c++11 -frounding-math -fsignaling-nans"])#setup
###################################################################################################