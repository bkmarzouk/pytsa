...
// Package recompile attempted at: Tue Nov  2 18:41:58 2021
...
// **************************************************************************************
static struct PyModuleDef PyTransModule = {PyModuleDef_HEAD_INIT, "PyTransPyTransTEST", PyTrans_docs, -1, PyTransPyTransTEST_funcs}; //modDef
// do not alter the comment at the end of preceeding line -- it is used by preprocessor

// **************************************************************************************
PyMODINIT_FUNC PyInit_PyTransPyTransTEST(void)    {    PyObject *m = PyModule_Create(&PyTransModule); import_array(); return m;} //initFunc
// do not alter the comment at the end of preceeding line -- it is used by preprocessor
